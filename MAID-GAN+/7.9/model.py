...
class Sample1(keras.Model):
    def __init__(self):
        ...
        self.conv = layers.Conv2D(81,32,32,padding='valid')

    def call(self, inputs):
        #print(inputs.shape)
        out = self.conv(inputs)
        out = shift_ps(out,9,9)
        return out

class Sample2(keras.Model):
    def __init__(self):
        super(Sample2, self).__init__()
        self.conv = layers.Conv2D(1024,9,9,padding='valid')
...
class Discriminator_w(keras.Model):
    def __init__(self):
        ...
        self.conv21 = layers.Conv2D(32,3,3,padding='same')
        self.conv22 = layers.Conv2D(1,5,1,padding='valid')
    ...
    def call(self, inputs):
        ...
        out2 = self.conv22(out2)#[B,18,18,1]
